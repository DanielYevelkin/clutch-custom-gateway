...
declare const CardHeader: ({ actions, avatar, children, title, summary }: CardHeaderProps) => JSX.Element;
...
declare const CardContent: ({ children, collapsible, collapseAction, maxHeight, ...props }: CardContentProps) => JSX.Element;
...
export declare const LandingCard: ({ group, title, description, icon, onClick, ...props }: LandingCardProps) => JSX.Element;
