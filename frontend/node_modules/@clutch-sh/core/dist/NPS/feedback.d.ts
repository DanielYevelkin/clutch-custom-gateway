...
/** Interfaces */
declare type Origin = "WIZARD" | "HEADER";
...
export declare const defaults: IClutch.feedback.v1.ISurvey;
export declare const FEEDBACK_MAX_LENGTH = 280;
/**
 ...
 */
declare const NPSFeedback: ({ origin, onSubmit, feedbackTypes, defaultFeedbackOption, }: FeedbackOptions) => JSX.Element;
