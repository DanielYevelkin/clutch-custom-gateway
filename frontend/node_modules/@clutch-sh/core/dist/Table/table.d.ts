...
import type { TableCellProps as MuiTableCellProps, TableProps as MuiTableProps, TableRowProps as MuiTableRowProps } from "@mui/material";
...
export interface TableRowProps extends Pick<MuiTableRowProps, "onClick">, Pick<MuiTableCellProps, "colSpan"> {
...
declare const TableRow: ({ children, onClick, cellDefault, responsive, colSpan, ...props }: TableRowProps) => JSX.Element;
